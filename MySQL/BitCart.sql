...
CREATE TABLE `category` (
  ...
  `super_category_id` int DEFAULT NULL,
  PRIMARY KEY (`category_id`),
  KEY `super_category_id` (`super_category_id`),
  CONSTRAINT `category_ibfk_1` FOREIGN KEY (`super_category_id`) REFERENCES `category` (`category_id`)
...
CREATE TABLE `order_product` (
  ...
  CONSTRAINT `order_product_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orderr` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orderr` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `orderr_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment` (
  ...
  `master_card` varchar(16) DEFAULT NULL,
  `cvv` char(3) DEFAULT NULL,
  PRIMARY KEY (`payment_id`),
  KEY `order_id` (`order_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orderr` (`order_id`),
...
-- Dump completed on 2024-12-04  3:15:52
